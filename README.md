...
# Performance analysis of MapleCare General Hospital_ SQL 🩺 
...
3. Monitoring doctor performance

4. Understanding cost & insurance coverage

5. Identifying high-risk patients

6. Analyzing medication usage
...
2. Most Common Diagnoses: [SQL](https://github.com/Stunga16/healthcare-SQL-analytics-project/blob/main/Top%2010%20Most%20Common%20Diagnoses)

Finds top diseases increasing hospital load.

3. 30-Day Readmission Rate:[SQL](https://github.com/Stunga16/healthcare-SQL-analytics-project/blob/main/Monthly%20Admissions%20Count)

Critical KPI in Canadian healthcare systems.

4. Department Workload Analysis:[SQL](https://github.com/Stunga16/healthcare-SQL-analytics-project/blob/main/Which%20Department%20Has%20the%20Highest%20Load%3F)

Supports staff/resource planning.

 5. Doctor Performance Dashboard:[SQL](https://github.com/Stunga16/healthcare-SQL-analytics-project/blob/main/Doctor%20Performance%20Dashboard)

Evaluates doctors based on patient volume & readmissions.

6. High-Risk Patients:[SQL](https://github.com/Stunga16/healthcare-SQL-analytics-project/blob/main/High-Risk%20Patients)

Patients with repeat visits or complications.

7. Financial Cost Analysis:[SQL](https://github.com/Stunga16/healthcare-SQL-analytics-project/blob/main/Average%20Out-of-Pocket%20Cost)

Insurance vs. out-of-pocket — helps financial planning.

8. Medication Usage:[SQL](https://github.com/Stunga16/healthcare-SQL-analytics-project/blob/main/Medication%20Usage%20Analysis)
